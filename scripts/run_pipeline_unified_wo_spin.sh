#!/bin/bash
#SBATCH --job-name=stfo_wo_pipe
#SBATCH --partition=eertekin-gpu
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --time=72:00:00
#SBATCH --output=/u/jaejunl3/GPUAlloy/logs/stfo_wo_pipe_%j.out

set -e
cd /u/jaejunl3/GPUAlloy
mkdir -p logs best_pkl/stfo_wo_spin_unified best_pkl/retrained_unified

source ~/.bashrc
conda activate neuralce2

CFG=./configs/tuning_unified/stfo_wo_spin.yaml
DATASET=stfo_wo_spin
OUT_DIR=./best_pkl/stfo_wo_spin_unified
